...
public class ParticleSystem {
    ...
    private float speedError, lifeError, scaleError = 0 , rotation;
    private boolean randomRotation = false;
    private Vector3f direction;
    private float directionDeviation = 0;
    private ParticlesTexture texture;
 
    private Random random = new Random();
 
    public ParticleSystem(ParticlesTexture texture, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
        this.pps = pps;
    ...
    private void setRotation(float rotY){
        this.rotation = rotY;
    }
